...
│  ├─ TrayApp.cs                 трей, таймер, смена обоев
│  ├─ WallhavenApi.cs            запросы к сайту и скачивание картинок
│  ├─ Cache.cs                   папка с картинками: выбор, чистка, перенос
│  ├─ State.cs                   страница топа и история показов
