...
Меняет обои рабочего стола Windows 11 на картинки из топа [Wallhaven](https://wallhaven.cc). Живёт в трее, настраивается в одном окне, оформлен под тёмную тему Windows 11.
